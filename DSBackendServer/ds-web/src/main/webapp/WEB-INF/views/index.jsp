...
<body>
	...
	<form:form action="${pageContext.servletContext.contextPath}/index.htm"
		commandName="index">
	...
	<div>
		<a
			href="${pageContext.servletContext.contextPath}/index/show-users.htm">Show
			all users</a>
					...
					<tbody>
						<c:forEach var="account" items="${accounts}">
							<tr>
								...
								<td><c:out value="${account.insertedAt}" /></td>
								<td><c:out value="${account.updatedAt}" /></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
