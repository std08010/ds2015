 ...
 *
 */
public abstract class AbstractServiceImplRead<T extends BaseEntity, PK extends Serializable> implements AbstractService<T, PK>
{
	public abstract AbstractDAOImplRead<T, PK> getDAO();

	public AbstractServiceImplRead()
	{
	}
