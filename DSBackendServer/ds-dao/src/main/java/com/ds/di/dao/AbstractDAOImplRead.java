 ...
 *
 */
public abstract class AbstractDAOImplRead<T extends BaseEntity, PK extends Serializable> implements AbstractDAO<T, PK>
{
	@PersistenceContext(unitName = "ds_read")
	@Qualifier(value = "entityManagerFactoryRead")
	private EntityManager	entityManager;

	private Class<T>		entityClass;

	public AbstractDAOImplRead(Class<T> entityClass)
	{
		this.entityClass = entityClass;
	}

	public AbstractDAOImplRead()
	{
	}
