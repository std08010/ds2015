 ...
 *
 */
@Repository(value = UserDAORead.SPRING_KEY)
@Scope(Globals.SPRING_SCOPE_PROTOTYPE)
@Transactional(value = "transactionManagerRead")
public class UserDAORead extends AbstractDAOImplRead<User, Long>
{
	public static final String	SPRING_KEY	= "com.ds.di.dao.user.UserDAORead";
