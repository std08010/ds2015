 ...
 *
 */
@Repository(value = VoteDAO.SPRING_KEY)
@Scope(Globals.SPRING_SCOPE_PROTOTYPE)
@Transactional(value = "transactionManager")
public class VoteDAO extends AbstractDAOImpl<Vote, Long>
{
	public static final String	SPRING_KEY	= "com.ds.di.dao.vote.VoteDAO";
