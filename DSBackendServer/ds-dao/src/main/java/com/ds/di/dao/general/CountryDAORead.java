 ...
 *
 */
@Repository(value = CountryDAORead.SPRING_KEY)
@Scope(Globals.SPRING_SCOPE_PROTOTYPE)
@Transactional(value = "transactionManagerRead")
public class CountryDAORead extends AbstractDAOImplRead<Country, Long>
{
	public static final String	SPRING_KEY	= "com.ds.di.dao.general.CountryDAORead";

	public CountryDAORead()
	{
		super(Country.class);
	}
