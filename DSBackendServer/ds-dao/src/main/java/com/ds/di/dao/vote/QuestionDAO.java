 ...
 *
 */
@Repository(value = QuestionDAO.SPRING_KEY)
@Scope(Globals.SPRING_SCOPE_PROTOTYPE)
@Transactional(value = "transactionManager")
public class QuestionDAO extends AbstractDAOImpl<Question, Long>
{
	public static final String	SPRING_KEY	= "com.ds.di.dao.vote.QuestionDAO";
