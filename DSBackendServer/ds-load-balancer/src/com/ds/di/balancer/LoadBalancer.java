...
class LoadBalancer {
	...
	public static void main(String[] args) throws Exception {
		ServerCollection servers = new ServerCollection(new InetSocketAddress[] {
			...
			new InetSocketAddress("10.0.0.11", 8080),
			new InetSocketAddress("10.0.0.11", 8081)
		});

		servers.startStatusUpdates(2000);
		
		HttpServer loadBalancer = new HttpServer(80, new LoadBalancerHandler(servers, "d:/balancerLog.txt"));
		loadBalancer.run();
