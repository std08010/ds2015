...
class LoadBalanceTester {
	...
	private static final String 	DOMAIN 			= "ec2-52-17-140-15.eu-west-1.compute.amazonaws.com/";
	private static final String 	HOME_URL 		= "ds-web";
	//private static final String 	REST_TEST_URL 	= "ds-web/rest/general/balancer/status";
	...
	public static void main(String[] args) throws Exception {
		...
		sendMassiveParallelRequests(NO_OF_THREADS, NO_OF_REQUESTS_100M, DOMAIN, REST_TEST_URL);
	}
